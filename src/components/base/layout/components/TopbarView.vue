<template>
  ...
  <div class="app-topbar">
    <div class="app-topbar__collapse" :class="{ unfold: true }" @click="true">
    ...
    <!-- 用户信息 -->
    <div class="app-topbar__user" v-if="true">
      <el-dropdown trigger="click" hide-on-click @command="onCommand">
        <span class="el-dropdown-link">
          <span class="name">管理员</span>
          <img class="avatar" src="https://b-img-storage.oss-cn-hangzhou.aliyuncs.com/blog/wallpaper_1.jpeg" />
        </span>
